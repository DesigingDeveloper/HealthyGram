...
const HomepageHeading = ({ mobile }) => ( 
  <Container text> 
    ...
    /> 
    <Button primary size="huge" inverted as="a" href="/dashboard"> 
              ...
              <Menu.Menu position="right"> 
                ...
                <Dropdown item text="Doctor"> 
                  <Dropdown.Menu> 
                    ...
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/edit-doctor"> 
                        Edit Profile 
                      </a> 
                    </Dropdown.Item> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/make-appointment"> 
                        Make Appointment 
                      </a> 
                    </Dropdown.Item> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/edit-appointment"> 
                        Update Appointment 
                      </a> 
                    </Dropdown.Item> 
                  </Dropdown.Menu> 
                ...
                <Dropdown item text="Patient"> 
                  <Dropdown.Menu> 
                    ...
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/edit-patient"> 
                        Edit Profile 
                      </a> 
                    </Dropdown.Item> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/approve-doctor"> 
                        Allow Access 
                      </a> 
                    </Dropdown.Item> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/revoke-doctor"> 
                        Revoke Access 
                      </a> 
                    </Dropdown.Item> 
                  </Dropdown.Menu> 
                ...
                <Dropdown item text="Register"> 
                  <Dropdown.Menu> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/register-patient"> 
                        Patient 
                      </a> 
                    </Dropdown.Item> 
                    <Dropdown.Item> 
                      <a style={{ color: "black" }} href="/register-doctor"> 
                        Doctor 
                      </a> 
                    </Dropdown.Item> 
                  </Dropdown.Menu> 
